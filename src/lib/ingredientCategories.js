...
/**
 * หน่วยย่อยที่ใช้ตวงตอนทำอาหาร
 *
 * ต่างจากหน่วยที่ซื้อมา — น้ำปลาซื้อเป็นขวด แต่ตอนทำน้ำจิ้มตวงเป็นมิลลิลิตร
 * บอกระบบว่า 1 ขวดมีกี่มิลลิลิตร แล้วกรอกสูตรเป็นมิลลิลิตรได้เลย ระบบหารเป็นเศษขวดให้เอง
 */
export const CONTENT_UNITS = ['มล.', 'ลิตร', 'กรัม', 'ขีด', 'กก.', 'ชิ้น', 'ช้อนโต๊ะ']

...
│  ├─ shoppingList.js        รายการซื้อของที่พกไปตลาด เก็บในเครื่อง ไม่แตะเน็ต
...
**ซื้อของ** สามจอ — เตรียมรายการ → ติ๊กและกรอกราคาในตลาด → ตรวจแล้วบันทึกเข้าคลัง
ระหว่างเดินตลาดเก็บใน localStorage ล้วน ไม่แตะฐานข้อมูลเลย เพราะตลาดสัญญาณไม่ดี
และระบบเขียนฐานข้อมูลตอนออฟไลน์ไม่ได้ แตะครั้งเดียวตอนกดบันทึก ซึ่งเขียนเป็น
`purchases` ปกติ — ของที่ซื้อจากหน้านี้จึงโผล่ในหน้าค่าใช้จ่ายและไฟล์ Excel เหมือนกัน ไม่มีบัญชีสองเล่ม
...
`components/Sauce*.jsx` `lib/sauceStock.js` `lib/shoppingList.js` `lib/useSauceBatches.js`
